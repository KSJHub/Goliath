...
export const api = {
  ...
  getSecurityProtectedAssets: (guildId) => request(`/api/security/${guildId}/protected-assets`),
  saveSecurityProtectedAssets: (guildId, payload) => request(`/api/security/${guildId}/protected-assets`, { method: 'PUT', body: JSON.stringify(payload) }),
