...
const moduleManifest = Object.freeze({
  ...
  schedule: { key: 'schedule', name: 'Schedule', maturity: MODULE_MATURITY.IN_PROGRESS, capabilities: createCapabilityMap({ guildStorage: true, runtime: true, adminPanel: true, dashboard: true, api: true, health: true, startupRecovery: true, export: true, reset: true, documentation: true }) },
