...
async function startupVerification(client) {
  ...
  console.log(
    `[Verification] Startup check complete: ${summary.guildsChecked} guild(s), ${summary.enabledGuilds} enabled, ${summary.totalPanels} panel(s), ${summary.totalWarnings} warning(s).`
  );
