...
/**
 * Canonical Tickets health layer.
 *
...
// ============================================================================
{
  ...
  const panelManager = require('./ticketsPanel');
  const recovery = require('./ticketsTracking');
...
module.exports = {
  ...ticketsHealthApi,
  ticketsHealth: ticketsHealthApi,
};
